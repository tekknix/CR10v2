...
#define STRING_CONFIG_H_AUTHOR "MoS-tekknix, CR10-V2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR10-V2-UBL"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 750, 750, 15, 60 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 47, -5, -1.60 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION   // Enable G26 mesh validation
    ...
    #define G26_XY_FEEDRATE         80    // (mm/s) Feedrate for XY Moves for the G26 Mesh Validation Tool.
